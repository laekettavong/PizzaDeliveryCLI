...
CliMap.set('get lowest order --{hourOffset}','Show lowest total order within last specific hours (optional hourOffset is the last 24 hours if not specified)');
...
CliMap.set('list wings metrics --{hourOffset}','List metrics of all checken wings sold within last specific hours (optional hourOffset is the last 24 hours if not specified)');
CliMap.set('list breadsticks metrics --{hourOffset}','List metrics of all breadticks sold within last specific hours (optional hourOffset is the last 24 hours if not specified)');
