...
CliMap.set('show total orders --{hourOffset}','Show total sale within last specific hours (optional hourOffset is the last 24 hours if not specified)');
CliMap.set('show highest order --{hourOffset}','Show highest total order within last specific hours (optional hourOffset is the last 24 hours if not specified)');
